...
from flask import Flask # Flask 實例化移到 create_app 中
...
def create_app(test_config=None):
    ...
    CORS(app,  
         ...
         supports_credentials=True, # 如果您需要在跨域請求中處理 cookie 或 Authorization header
         expose_headers=["Content-Type", "Authorization"] # 根據需要暴露的 header
    )
